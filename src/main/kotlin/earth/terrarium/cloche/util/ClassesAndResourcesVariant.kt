...
internal fun Project.configureClassesAndResourcesVariant(sourceSet: SourceSet) {
    configurations.named(sourceSet.runtimeElementsConfigurationName) {
        ...
        val classesAndResourcesVariant = configureClassesAndResourcesVariant(configuration)
...
internal fun Project.configureClassesAndResourcesVariant(configuration: Configuration): ConfigurationVariant {
    val classesAndResourcesVariants = configuration.outgoing.variants.named { it == LibraryElements.CLASSES || it == LibraryElements.RESOURCES }

    return configuration.outgoing.variants.maybeCreate(
