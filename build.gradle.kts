...
dependencies {
    implementation(group = "net.msrandom", name = "minecraft-codev-forge", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-fabric", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-mixins", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-runs", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-access-widener", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-remapper", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-decompiler", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-includes", version = "0.5.25")
    implementation(group = "net.msrandom", name = "minecraft-codev-intersections", version = "0.5.25")
