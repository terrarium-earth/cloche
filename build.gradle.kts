...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-decompiler", version = "1.0.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-includes", version = "1.0.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-intersections", version = "1.0.0")
