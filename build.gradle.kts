...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-fabric", version = "0.6.5")
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-remapper", version = "0.6.5")
